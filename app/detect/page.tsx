...
export default function DetectPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="border-b border-slate-200 bg-gradient-to-b from-emerald-50 to-slate-50 px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-2xl text-slate-600">
              Upload an image, describe symptoms, and review a ChatGPT-style history panel with your latest analyses on the left.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-6 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[320px_minmax(0,1fr)]">
          <aside className="rounded-3xl border border-slate-800 bg-slate-950 text-slate-100 shadow-2xl shadow-slate-950/20">
            <div className="border-b border-slate-800 p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Recent analysis sessions</p>
                </div>
              </div>
            </div>
